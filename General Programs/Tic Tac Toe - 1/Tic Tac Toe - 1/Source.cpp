...
void inputCord(char[][3]);
int checkresult(char[][3]);
...
void inputCord(char board[][3])
{
	...
	if (turn % 2 == 1)
	{
		do
		{
			cout << "Player-1 turn:\t";
			cin >> x >> y;
			if (x < 0 || y < 0 || x>3 || y>3 || comp[x][y] == 'A')
				cout << "Invalid Input......\n";
		} while (x < 0 || y < 0 || x>3 || y>3 || comp[x][y] == 'A');
		comp[x][y] = 'A';
		board[x][y] = 'X';
	}
...
int checkresult(char board[][3])
{
	...
	//For checking that either player-2 has won or not if above conditions are false
		...
		board[0][0] == 'Y' && board[0][0] == board[0][1] && board[0][1] == board[0][2] ||
		board[1][0] == 'Y' && board[1][0] == board[1][1] && board[1][1] == board[1][2] ||
		board[2][0] == 'Y' && board[2][0] == board[2][1] && board[2][1] == board[2][2] ||
		board[0][0] == 'Y' && board[0][0] == board[1][0] && board[1][0] == board[2][0] ||
		board[0][1] == 'Y' && board[0][1] == board[1][1] && board[1][1] == board[2][1] ||
		board[0][2] == 'Y' && board[0][2] == board[1][2] && board[1][2] == board[2][2] ||
		board[0][0] == 'Y' && board[0][0] == board[1][1] && board[1][1] == board[2][2] ||
		board[0][2] == 'Y' && board[0][2] == board[1][1] && board[1][1] == board[2][0]
		)
