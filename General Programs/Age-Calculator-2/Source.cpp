...
In days,hours,minutes,seconds format; number of days in 1 year= (30*12=)360.
*/
...
int main()
{
	...
	cout << "\n\nYour CURRENT AGE is:\n";
	cout << "\t\t=>"<< AgeYears << " years, " << AgeMonths << " months and " << AgeDays << " days\n";
	cout << "\t\t=>" << AgeYears * 12 + AgeMonths << " months and " << AgeDays << " days\n";
	cout << "\t\t=>" << (AgeYears * 12 + AgeMonths) * 30 + AgeDays << " days\n";
	cout << "\t\t=>" << ((AgeYears * 12 + AgeMonths) * 30 + AgeDays)*24 << " hours\n";
	cout << "\t\t=>" << (((AgeYears * 12 + AgeMonths) * 30 + AgeDays) * 24)*60 << " minutes\n";
	cout << "\t\t=>" << ((((AgeYears * 12 + AgeMonths) * 30 + AgeDays) * 24) * 60)*60 << " seconds\n\n";
